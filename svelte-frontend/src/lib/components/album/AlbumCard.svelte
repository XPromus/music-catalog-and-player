<script lang="ts">
    ...
    onMount(async () => {
        coverImageURL = AlbumAPI.getImageURL(albumData);
    });

</script>

<div id="card" class="bg-white dark:bg-neutral-900 max-w-xs">
    <img class="aspect-square object-contain w-full bg-neutral-300" src="{coverImageURL}" alt=""/>
    <div class="p-6">
